...
import bg_1 from "../assets/image/bg_1.jpeg";
import bg_2 from "../assets/image/bg_2.jpeg";
import bg_3 from "../assets/image/bg_3.jpeg";
import bg_4 from "../assets/image/bg_4.jpeg";
import bg_5 from "../assets/image/bg_5.png";
import bg_6 from "../assets/image/bg_6.jpeg";
import bg_7 from "../assets/image/bg_7.jpeg";
import bg_8 from "../assets/image/bg_8.jpeg";
import bg_9 from "../assets/image/bg_9.jpeg";
import bg_10 from "../assets/image/bg_10.jpeg";
...
export const DATA = [
    ...
    },
    {
        ...
        runningTime: "1시간 32분",
        age: "전체 관람가",
        description: `따단-딴-따단-딴 ♫ 
    전 세계를 열광시킬 올 타임 슈퍼 어드벤처의 등장! 
    
    뉴욕의 평범한 배관공 형제 '마리오'와 '루이지'는 배수관 고장으로 위기에 빠진 도시를 구하려다 미스터리한 초록색 파이프 안으로 빨려 들어가게 된다. 파이프를 통해 새로운 세상으로 차원 이동하게 된 형제. 형 '마리오'는 뛰어난 리더십을 지닌 '피치'가 통치하는 버섯왕국에 도착하지만 동생 '루이지'는 빌런 '쿠파'가 있는 다크랜드로 떨어지며 납치를 당하고 '마리오'는 동생을 구하기 위해 '피치'와 '키노피오'의 도움을 받아 '쿠파'에 맞서기로 결심한다. 그러나 슈퍼스타로 세상을 지배하려는 그의 강력한 힘 앞에 이들은 예기치 못한 위험에 빠지게 되는데...!
    ...
    },
    {
        ...
        percent: "9.4%",
        audience: "40000",
        originalTitle: "映画クレヨンしんちゃん もののけニンジャ珍風伝",
        genre: "애니메이션/모험",
        runningTime: "1시간 40분",
        age: "전체 관람가",
        description: `사실... 짱구는 닌자 가문의 후계자였다?! 
    ...
    },
    {
        ...
        runningTime: "",
        age: "15세 관람가",
        description: `다니던 회사의 사장으로 인해 바닥으로 추락한 남자가 전직 소매치기 출신 격투기 선수, 강사 출신 트레이너를 만나 우여곡절 끝에 어려움을 극복하고 성공에 이르는 과정을 담은 드라마.`,
        bg: bg_4,
        bgColor: "#235F13",
    },
    {
        ...
        runningTime: "2시간 1분",
        age: "12세 관람가",
        description: `"이 근처에 폐허 없니? 문을 찾고 있어"
    ...
    },
    {
        ...
        runningTime: "2시간 21분",
        age: "15세 관람가",
        description: `아무리 빨리 달려도 과거를 앞지를 순 없다 
    ...
    },
    {
        ...
        runningTime: "2시간 49분",
        age: "청소년 관람불가",
        description: `죽을 위기에서 살아난 '존 윅'은 '최고 회의'를 쓰러트릴 방법을 찾아낸다. 비로소 완전한 자유의 희망을 보지만, NEW 빌런 '그라몽 후작'과 전 세계의 최강 연합은 존 윅의 오랜 친구까지 적으로 만들어 버리고, 새로운 위기에 놓인 존 윅은 최후의 반격을 준비하는데..
    ...
    },
    {
        ...
        percent: "1.4%",
        audience: "604",
        originalTitle: "문재인입니다",
        genre: "다큐멘터리",
        runningTime: "1시간 54분",
        age: "12세 관람가",
        description: `모두가 알지만 누구도 한 단어로 정의하지 못한 사람
    ...
    },
    {
        ...
        runningTime: "1시간 41분",
        age: "12세 관람가",
        description: `"5년 만나는 동안 이렇게 떨어져 본 적 있나?" 

외제차 딜러인 '도하'와 인디밴드 '연신굽신'의 메인 보컬 '태인'은 5년 차 달달 커플이다. 서른을 앞두고, 밴드 활동에 위기가 찾아오자 '태인'은 곡 작업을 위해 고향인 거제로 내려갈 결심을 하고, '태인'의 갑작스러운 결정에 '도하'는 울며 겨자 먹기로 장거리 연애를 수락한다. 롱디임에도 매일매일 쉴 새 없는 카톡과 영상통화로 넘쳐나는 사랑을 표현하던 '도하'는 결국 5주년 기념일 맞이 깜짝 프로포즈를 준비하고. 특급 고객 '제임스'는  같은 날 파티를 주최하는 것도 모자라 '도하'에게 거절할 수 없는 제안을 한다. 잠깐 들르기만 하려던 '도하'의 계획은 필름이 끊기면서, 차질이 생기고. 설상가상 그날의 사건(?)이 SNS에 퍼지며 일과 사랑 모두 총체적 난국을 맞이한다.
